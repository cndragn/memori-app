...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { language: @deck.language, original: @deck.original, target: @deck.target } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { language: @deck.language, original: @deck.original, target: @deck.target } }
